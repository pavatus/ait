	...
	public void tick() {
		if (this.block.isAir()) {
			...
			if (!this.getWorld().isClient) {
				...
				getTardis().getTravel().setPosition(new AbsoluteBlockPos.Directed(BlockPos.ofFloored(this.getPos()), this.getWorld(), this.getTardis().getTravel().getPosition().getSpecific()));
