...
public class CoralPlantBlock extends HorizontalDirectionalBlock implements BlockEntityProvider {
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (this.getAge(state) >= this.getMaxAge()) {
            // Create a new tardis
            ServerTardis created = ServerTardisManager.getInstance().create(new AbsoluteBlockPos.Directed(pos, world, Direction.NORTH), AITExteriors.get(CapsuleExterior.REFERENCE), AITExteriorVariants.get(new Identifier(AITMod.MOD_ID, "capsule_default")), DesktopRegistry.CAVE, false);
