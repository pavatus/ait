...
public class TelepathicControl extends Control {
	...
	public boolean runServer(Tardis tardis, ServerPlayerEntity player, ServerWorld world) {
		...
		if (found == null) {
			...
			tardis.getTravel().setDestination(new AbsoluteBlockPos.Directed(found.add(0, 75, 0), tardis.getTravel().getDestination().getWorld(), tardis.getTravel().getDestination().getSpecific()), true);
