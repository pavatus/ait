...
public class DimensionControl extends Control {
	...
	public boolean runServer(Tardis tardis, ServerPlayerEntity player, ServerWorld world) {
		...
		travel.setDestination(new AbsoluteBlockPos.Directed(PosType.Y.add(dest, 0), dims.get(next), dest.getSpecific()), false); // postype.y.add means it clamps the y coord fixme doesnt work for nether as u can go above the bedrock but dont hardcode it like you did loqor :(
