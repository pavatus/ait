...
public class SteamConsole extends ConsoleSchema {
    ...
    private static final ControlTypes[] TYPES = new ControlTypes[]{
            ...
            new ControlTypes(new DoorControl(), EntityDimensions.changing(0.1375f, 0.1625f), new Vector3f(-0.6398437712341547f, 0.4249996170401573f, -0.6144531266763806f)),
            ...
            new ControlTypes(new XControl(), EntityDimensions.changing(0.074999996f, 0.099999994f), new Vector3f(0.35234376322478056f, 0.5749996183440089f, -0.40859375055879354f)),
            new ControlTypes(new YControl(), EntityDimensions.changing(0.074999996f, 0.1f), new Vector3f(0.2640625135973096f, 0.5750001911073923f, -0.46054687537252903f)),
            new ControlTypes(new ZControl(), EntityDimensions.changing(0.074999996f, 0.1f), new Vector3f(0.17656251415610313f, 0.5749998101964593f, -0.51171875f)),
            new ControlTypes(new RandomiserControl(), EntityDimensions.changing(0.16250001f, 0.16250001f), new Vector3f(-0.39062499161809683f, 0.7249996224418283f, 0.0011718804016709328f)),
            new ControlTypes(new DirectionControl(), EntityDimensions.changing(0.1375f, 0.17500001f), new Vector3f(-0.8890624968335032f, 0.38750038016587496f, -0.287109381519258f)),
            new ControlTypes(new HailMaryControl(), EntityDimensions.changing(0.07499999f, 0.1f), new Vector3f(-0.72265625f, 0.4749998077750206f, 0.08906249981373549f)),
            new ControlTypes(new CloakControl(),EntityDimensions.changing(0.06249999f, 0.18750001f), new Vector3f(-0.18515625223517418f, 0.4000003803521395f, -0.9226562483236194f)),
            new ControlTypes(new SiegeModeControl(), EntityDimensions.changing(0.074999996f, 0.1f), new Vector3f(-0.19609374646097422f, 0.5749998092651367f, 0.45195312425494194f)),
            new ControlTypes(new DimensionControl(), EntityDimensions.changing(0.125f, 0.1125f), new Vector3f(-0.7640624977648258f, 0.3700000746175647f, 0.6269531277939677f)),
            new ControlTypes(new RefuelerControl(), EntityDimensions.changing(0.07499999f, 0.16250001f), new Vector3f(0.7882812572643161f, 0.45000019017606974f, -0.19296873733401299f)),
