...
public class BorealisConsole extends ConsoleSchema {
    ...
    private static final ControlTypes[] TYPES = new ControlTypes[] {
            ...
            new ControlTypes(new HADSControl(), EntityDimensions.changing(0.074999996f, 0.099999994f), new Vector3f(0.6406250018626451f, 0.625000286847353f, -0.14765625819563866f)),
