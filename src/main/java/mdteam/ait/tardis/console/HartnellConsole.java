...
import mdteam.ait.tardis.control.impl.waypoint.GotoWaypointControl;
...
public class HartnellConsole extends ConsoleSchema {
    ...
    private static final ControlTypes[] TYPES = new ControlTypes[]{
            ...
            new ControlTypes(new GotoWaypointControl(), EntityDimensions.changing(0.125f, 0.1f), new Vector3f(0.7906250040978193f, 1.0250002853572369f, 0.45234375074505806f)),
            new ControlTypes(new SetWaypointControl(), EntityDimensions.changing(0.125f, 0.1f), new Vector3f(0.7906250040978193f, 1.5250002853572369f, 0.45234375074505806f)),
            new ControlTypes(new EjectWaypointControl(), EntityDimensions.changing(0.125f, 0.1f), new Vector3f(0.7906250040978193f, 2.0250002853572369f, 0.45234375074505806f)),
    };
