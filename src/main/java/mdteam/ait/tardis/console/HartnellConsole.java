...
public class HartnellConsole extends ConsoleSchema {
    ...
    private static final ControlTypes[] TYPES = new ControlTypes[]{
            ...
            new ControlTypes(new SiegeModeControl(), EntityDimensions.changing(0.074999996f, 0.1f), new Vector3f(-0.7218750026077032f, 0.5749999508261681f, 0.10117187909781933f)), // 15
