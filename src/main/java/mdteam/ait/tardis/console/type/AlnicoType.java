...
public class AlnicoType extends ConsoleTypeSchema {
    ...
    private static final ControlTypes[] TYPES = new ControlTypes[]{
            new ControlTypes(new ThrottleControl(), EntityDimensions.changing(0.2375f, 0.5374998f), new Vector3f(-0.7960937507450581f, 0.27500009536743164f, 1.3906250018626451f)),
            ...
            new ControlTypes(new RefuelerControl(), EntityDimensions.changing(0.22500002f, 0.23750003f), new Vector3f(-0.73828125f, 0.27499961853027344f, -1.28125f)),
