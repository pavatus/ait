...
public class ShieldsModel extends SinglePartEntityModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData shields = modelPartData.addChild("shields", ModelPartBuilder.create().uv(0, 0).cuboid(-32.0F, -32.0F, -32.0F, 64.0F, 64.0F, 64.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
