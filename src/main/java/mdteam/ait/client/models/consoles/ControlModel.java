...
public class ControlModel extends SinglePartEntityModel<ConsoleControlEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create().uv(9, 0).cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-1.0F, -11.0F, -1.0F, 2.0F, 8.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
    ...
    public static TexturedModelData getNotModelData() {
        ModelData modelData = new ModelData();
        ModelPartData modelPartData = modelData.getRoot();
        ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create().uv(0, 0).cuboid(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, new Dilation(0.0F))
