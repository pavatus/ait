...
public class PlinthDoorModel extends DoorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData door = plinth.addChild("door", ModelPartBuilder.create().uv(72, 61).cuboid(-12.0F, -42.0F, -2.0F, 12.0F, 42.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(6.0F, 0.0F, -6.0F));

		ModelPartData frame = plinth.addChild("frame", ModelPartBuilder.create().uv(56, 0).cuboid(11.0F, -48.0F, -8.0F, 18.0F, 3.0F, 3.0F, new Dilation(0.0F))
		.uv(28, 79).cuboid(26.0F, -45.0F, -8.0F, 2.0F, 42.0F, 2.0F, new Dilation(0.0F))
		.uv(36, 79).cuboid(12.0F, -45.0F, -8.0F, 2.0F, 42.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-20.0F, 3.0F, 0.0F));
