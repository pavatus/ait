...
public class HartnellAnimations {
    ...
    public static final Animation HARTNELL_POWER_ON_ANIMATION = Animation.Builder.create(9.291676f)
            ...
            .addBoneAnimation("bone168",
                    new Transformation(Transformation.Targets.SCALE,
                            new Keyframe(0f, AnimationHelper.createScalingVector(1f, -0.7f, 1f),
                                    STEP)))
            .addBoneAnimation("bone171",
                    new Transformation(Transformation.Targets.SCALE,
                            new Keyframe(0f, AnimationHelper.createScalingVector(1f, 0f, 1f),
            ...
            .addBoneAnimation("bone86",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
                                    STEP),
                            new Keyframe(9.083434f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    STEP)))
            .addBoneAnimation("bone87",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
            ...
            .addBoneAnimation("bone85",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
                                    STEP),
                            new Keyframe(7.541677f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    STEP)))
            .addBoneAnimation("bone111",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
    ...
    public static final Animation HARTNELL_POWER_OFF_ANIMATION = Animation.Builder.create(4f)
            ...
            .addBoneAnimation("bone92",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    STEP),
                            new Keyframe(1.375f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
                                    STEP)))
            .addBoneAnimation("bone94",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
            ...
            .addBoneAnimation("bone116",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    STEP),
                            new Keyframe(2.5416765f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
                                    STEP)))
            .addBoneAnimation("bone126",
                    new Transformation(Transformation.Targets.ROTATE,
                            new Keyframe(0f, AnimationHelper.createRotationalVector(0f, -40f, 0f),
            ...
            .addBoneAnimation("bone86",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    STEP),
                            new Keyframe(3.9167665f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
                                    STEP)))
            .addBoneAnimation("bone87",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
            ...
            .addBoneAnimation("bone82",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    STEP),
                            new Keyframe(1.875f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
                                    STEP)))
            .addBoneAnimation("bone83",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
            ...
            .addBoneAnimation("bone111",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    STEP),
                            new Keyframe(2.7083435f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
                                    STEP)))
            .addBoneAnimation("bone101",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
            ...
            .addBoneAnimation("bone102",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
                                    STEP),
                            new Keyframe(2.875f, AnimationHelper.createTranslationalVector(0f, -1f, 0f),
                                    STEP)))
            .addBoneAnimation("bone103",
                    new Transformation(Transformation.Targets.TRANSLATE,
                            new Keyframe(0f, AnimationHelper.createTranslationalVector(0f, 0f, 0f),
    ...
    /*public static HashMap<Integer, ControlAnimationState> animationStatePerControl(List<Animation> animList) {
        HashMap<Integer, ControlAnimationState> map = new HashMap<>();
        for(int i = 0; i < animList.size(); i++) {
            Animation animation = animList.get(i);
            ControlAnimationState animationState = new ControlAnimationState(animation);
            map.put(i, animationState);
        }
        return map;
    }

    public static int animationOnIdFromControlName(String id) {
        return switch(id) {
            default -> 62;
            case "randomiser" -> 40;
            *//*case "refueler" -> 41;*//*
    ...
    public static int animationFromDirection(TardisTravel travel) {
        return switch(travel.getDestination().getDirection()) {
            default -> 16;
            case EAST -> 17;
            case SOUTH -> 18;
            case WEST -> 19;
