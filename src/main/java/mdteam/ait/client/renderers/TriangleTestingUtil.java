...
public class TriangleTestingUtil {
    ...
    public static void renderTriangle(WorldRenderContext context) {
        ...
        Vec3d targetPosition = new Vec3d(-82, 63, 55);
        ...
        for (int i = 0; i < 6; ++i) {
            ...
            buffer.vertex(positionMatrix, -0.5f, 0, -0.865625f).color(1f, 0f, 0f, 1f).texture(0f, 1f).next();
            buffer.vertex(positionMatrix, 0.5f, 0, -0.865625f).color(0f, 1f, 0f, 1f).texture(1f, 1f).next();
