	...
	public void render(AITRadioBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        matrices.push();
            ...
            matrices.push();
                ...
                if (renderOnThings) this.textRenderer.drawWithOutline(vol, 0.25f, 0.25f, colorWhite, colorBlack, matrices.peek().getPositionMatrix(), vertexConsumers, light);
            matrices.pop();
            ...
            matrices.push();
                ...
                //System.out.println((this.textRenderer.getWidth(text) / 1920F * 0.015F) / 0.075f);
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-90));
                if (renderOnThings) this.textRenderer.drawWithOutline(tuner, 0.25f, 0.25f, colorWhite, colorBlack, matrices.peek().getPositionMatrix(), vertexConsumers, light);
            matrices.pop();
            ...
            matrices.push();
                ...
                //System.out.println((this.textRenderer.getWidth(text) / 1920F * 0.015F) / 0.075f);
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-90));
                if (renderOnThings) this.textRenderer.drawWithOutline(volNum, 0.25f, 0.25f, colorWhite, colorBlack, matrices.peek().getPositionMatrix(), vertexConsumers, light);
            matrices.pop();
            ...
            matrices.push();
                ...
                //System.out.println((this.textRenderer.getWidth(text) / 1920F * 0.015F) / 0.075f);
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-90));
                if (renderOnThings) this.textRenderer.drawWithOutline(frequency, 0.25f, 0.25f, colorWhite, colorBlack, matrices.peek().getPositionMatrix(), vertexConsumers, maxLight);
            matrices.pop();
            ...
            matrices.push();
                ...
                //System.out.println((this.textRenderer.getWidth(text) / 1920F * 0.015F) / 0.075f);
                matrices.multiply(RotationAxis.POSITIVE_Y.rotationDegrees(-90));
                if (renderOnThings) this.textRenderer.drawWithOutline(fm, 0.25f, 0.25f, colorWhite, colorBlack, matrices.peek().getPositionMatrix(), vertexConsumers, maxLight);
            matrices.pop();
            ...
            matrices.push();
                ...
                if (renderOnThings)
		        	...
		        	} else new Error("Name is too long!", new Throwable(AITMod.MOD_ID + ": name in AITRadioRenderer exceeds 10 character units"));
            matrices.pop();
