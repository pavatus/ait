...
public class EngineBlockEntity extends LinkableBlockEntity implements ImplementedInventory {
	...
	public void useOn(World world, boolean sneaking, PlayerEntity player) {
		...
		AITMod.openScreen((ServerPlayerEntity) player, 1, this.findTardis().get().getUuid());
	}
