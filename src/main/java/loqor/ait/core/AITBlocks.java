...
public class AITBlocks implements BlockRegistryContainer {
    ...
    public static final Block PEANUT = new PeanutBlock(FabricBlockSettings.copy(Blocks.OBSIDIAN).emissiveLighting((state, world, pos) -> true).luminance(value -> 128).slipperiness(100));
