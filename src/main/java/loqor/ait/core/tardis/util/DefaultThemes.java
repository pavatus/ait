...
public enum DefaultThemes {
    ...
    RENAISSANCE("accursed", "exterior/police_box/renaissance", "renaissance", "todo"), // todo - this and CRYSTALLINE freeze the game when the interior tries to generate, so ive temporarily replaced them with the default desktop
    WAR(AITMod.id("war"), new Identifier("frooploof", "coral_war"), AITMod.id("coral"), AITMod.id("console/coral")),
    CRYSTALLINE("accursed", "exterior/police_box/renaissance", "renaissance", "todo"),
