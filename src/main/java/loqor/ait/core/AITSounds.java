...
public class AITSounds implements AutoRegistryContainer<SoundEvent> {
	...
	public static final MatSound DEMAT_ANIM = new MatSound(DEMAT, 240, 240, 240, 200, 0.2f, 0.4f); // fixme especially this one it flickers bad
	public static final MatSound MAT_ANIM = new MatSound(MAT, 460, 240, 240, 200, 0.2f, 0.4f);
	public static final MatSound FLIGHT_ANIM = new MatSound(FLIGHT_LOOP, 120, 60, 60, 60, 0, 0);
	public static final MatSound EIGHT_DEMAT_ANIM = new MatSound(EIGHT_DEMAT, 8 * 20, 8 * 20, 8 * 20, 8 * 20, 0.1f, 0.3f);
	...
	public static final MatSound LANDED_ANIM = new MatSound(null, 0, 0, 0, 0, 0, 0);
