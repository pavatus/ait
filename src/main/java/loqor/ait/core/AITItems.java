...
public class AITItems {
    ...
    public static final Item TARDIS_ITEM = new TardisItemBuilder(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP).fireproof().maxCount(1));
    @NoEnglish
    public static final Item SIEGE_ITEM = new SiegeTardisItem(new Item.Settings().fireproof());
    ...
    public static final Item GOLD_KEY = new KeyItem(
            new Item.Settings().rarity(Rarity.UNCOMMON).group(AITMod.AIT_ITEM_GROUP), KeyItem.Protocols.SNAP);
    public static final Item NETHERITE_KEY = new KeyItem(
            new Item.Settings().rarity(Rarity.RARE).group(AITMod.AIT_ITEM_GROUP).fireproof(), KeyItem.Protocols.SNAP,
            KeyItem.Protocols.HAIL);
    public static final Item CLASSIC_KEY = new KeyItem(
            new Item.Settings().rarity(Rarity.EPIC).group(AITMod.AIT_ITEM_GROUP), KeyItem.Protocols.SNAP,
            KeyItem.Protocols.HAIL);

    // Creative only skeleton key
    public static final Item SKELETON_KEY = new KeyItem(
            new Item.Settings().rarity(Rarity.EPIC).group(AITMod.AIT_ITEM_GROUP), KeyItem.Protocols.SKELETON,
    ...
    public static final Item GOLD_KEY_UPGRADE_SMITHING_TEMPLATE = new KeySmithingTemplateItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), "Gold Key", "Gold Nugget");
    @NoEnglish
    public static final Item NETHERITE_KEY_UPGRADE_SMITHING_TEMPLATE = new KeySmithingTemplateItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), "Netherite Key", "Netherite Scrap");
    @NoEnglish
    public static final Item CLASSIC_KEY_UPGRADE_SMITHING_TEMPLATE = new KeySmithingTemplateItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), "Classic Key", "Amethyst Shard");
    ...
    public static final Item ZEITON_DUST = new Item(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP).food(ZEITON_DUST_FOOD));
    ...
    public static final Item DEMATERIALIZATION_CIRCUIT = new SubSystemItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), SubSystem.Id.DEMAT);

    public static final Item SHIELDS_CIRCUIT = new SubSystemItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), SubSystem.Id.SHIELDS);
    public static final Item BACKUP_CIRCUIT = new SubSystemItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), SubSystem.Id.EMERGENCY_POWER);
    public static final Item GRAVITATIONAL_CIRCUIT = new SubSystemItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), SubSystem.Id.GRAVITATIONAL);
    public static final Item CHAMELEON_CIRCUIT = new SubSystemItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), SubSystem.Id.CHAMELEON);
    public static final Item DESPERATION_CIRCUIT = new SubSystemItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), SubSystem.Id.DESPERATION);
    public static final Item STABILISERS = new SubSystemItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), SubSystem.Id.STABILISERS);
    public static final Item LIFE_SUPPORT = new SubSystemItem(
            new Item.Settings().group(AITMod.AIT_ITEM_GROUP), SubSystem.Id.LIFE_SUPPORT);



    // Blueprint
    public static final Item BLUEPRINT = new BlueprintItem(
            new new Item.Settings().rarity(Rarity.EPIC));
