...
public class RedecorateCriterion extends AbstractCriterion<RedecorateCriterion.Conditions> {
    public static final Identifier ID = new Identifier(AITMod.MOD_ID, "redecorate");
