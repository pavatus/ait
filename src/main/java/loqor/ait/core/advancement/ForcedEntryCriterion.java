...
public class ForcedEntryCriterion extends AbstractCriterion<ForcedEntryCriterion.Conditions> {
    public static final Identifier ID = new Identifier(AITMod.MOD_ID, "forced_entry");
