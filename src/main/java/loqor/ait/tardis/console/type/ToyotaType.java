...
public class ToyotaType extends ConsoleTypeSchema {
	...
	private static final ControlTypes[] TYPES = new ControlTypes[]{
			new ControlTypes(new ThrottleControl(), EntityDimensions.changing(0.21249999f, 0.20000002f), new Vector3f(0.4406250063329935f, 0.5749999973922968f, 1.4359375312924385f)),
			new ControlTypes(new HandBrakeControl(), EntityDimensions.changing(0.20000002F, 0.15F), new Vector3f(-0.5257812738418579f, 0.5624998137354851f, 1.4125000340864062f)),
			new ControlTypes(new AutoPilotControl(), EntityDimensions.changing(0.1125f, 0.1f), new Vector3f(-0.3960937447845936f, 0.6500001922249794f, 1.053125012665987f)),
			new ControlTypes(new FastReturnControl(), EntityDimensions.changing(0.087500006f, 0.11250001f), new Vector3f(0.6617187494412065f, 0.5750001911073923f, 1.4593750247731805f)),
			new ControlTypes(new DoorControl(), EntityDimensions.changing(0.16250001f, 0.175f), new Vector3f(-0.3773437738418579f, 0.5874998141080141f, -1.3984375316649675f)),
			...
			new ControlTypes(new XControl(), EntityDimensions.changing(0.08749999f, 0.08749999f), new Vector3f(-0.7867187764495611f, 0.699999812990427f, -0.545312512665987f)),
			new ControlTypes(new YControl(), EntityDimensions.changing(0.0875f, 0.0875f), new Vector3f(-1.046875030733645f, 0.649999812245369f, -0.43593750800937414f)),
			new ControlTypes(new ZControl(), EntityDimensions.changing(0.0875f, 0.0875f), new Vector3f(-1.0875000320374966f, 0.6000000024214387f, -0.7234375094994903f)),
			new ControlTypes(new RandomiserControl(), EntityDimensions.changing(0.1375f, 0.07499999f), new Vector3f(0.5851562554016709f, 0.5750001901760697f, -1.425000013783574f)),
			new ControlTypes(new DirectionControl(), EntityDimensions.changing(0.1125f, 0.1125f), new Vector3f(0.5375000080093741f, 0.7500000055879354f, -0.6265625292435288f)),
			new ControlTypes(new HailMaryControl(), EntityDimensions.changing(0.1125f, 0.125f), new Vector3f(-0.9585937466472387f, 0.5749996211379766f, -1.2625000290572643f)),
			...
			new ControlTypes(new SiegeModeControl(), EntityDimensions.changing(0.20000002f, 0.22500002f), new Vector3f(-0.004687480628490448f, 0.13750028610229492f, 1.5132812839001417f)),
