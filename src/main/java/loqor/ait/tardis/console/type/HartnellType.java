...
public class HartnellType extends ConsoleTypeSchema {
	...
	private static final ControlTypes[] TYPES = new ControlTypes[]{
			...
			new ControlTypes(new SonicPortControl(), EntityDimensions.changing(0.125f, 0.08749999f), new Vector3f(-0.4359374921768904f, 0.6249999944120646f, -0.26015625055879354f)),
			new ControlTypes(new ShieldsControl(), EntityDimensions.changing(0.099999994f, 0.07499999f), new Vector3f(-0.5734374923631549f, 0.5374997593462467f, 0.662500019185245f)),
	};
