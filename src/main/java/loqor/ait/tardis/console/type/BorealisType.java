...
public class BorealisType extends ConsoleTypeSchema {
	...
	private static final ControlTypes[] TYPES = new ControlTypes[]{
			...
			new ControlTypes(new DoorLockControl(), EntityDimensions.changing(0.087499976f, 0.087499976f), new Vector3f(0.0f, 0.6249998994171619f, 0.6003906223922968f)),
			...
			new ControlTypes(new PowerControl(), EntityDimensions.changing(0.074999996f, 0.099999994f), new Vector3f(0.6406250018626451f, 0.625000286847353f, -0.14765625819563866f)),
