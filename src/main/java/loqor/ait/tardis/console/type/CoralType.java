...
public class CoralType extends ConsoleTypeSchema {
	...
	private static final ControlTypes[] TYPES = new ControlTypes[]{
			...
			new ControlTypes(new MarkWaypointControl(), EntityDimensions.changing(0.07499999f, 0.074999996f), new Vector3f(0.80078125f, 0.537500761449337f, 0.07656250149011612f)),
			...
			new ControlTypes(new ShieldsControl(), EntityDimensions.changing(0.099999994f, 0.21250002f), new Vector3f(-1.2734375027939677f, 0.1874997541308403f, -0.5624999990686774f)),
	};
