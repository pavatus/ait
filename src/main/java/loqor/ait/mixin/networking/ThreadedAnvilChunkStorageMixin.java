...
public abstract class ThreadedAnvilChunkStorageMixin {
    ...
    @Shadow
    protected abstract void sendChunkDataPackets(ServerPlayerEntity player,
            MutableObject<ChunkDataS2CPacket> cachedDataPacket, WorldChunk chunk);
    ...
    protected void sendWatchPackets(ThreadedAnvilChunkStorage instance, ServerPlayerEntity player,
            MutableObject<ChunkDataS2CPacket> cachedDataPacket, WorldChunk chunk) {
    ...
    protected void sendWatchPackets(ServerPlayerEntity instance, ChunkPos chunkPos) {
