...
public class DatapackMachineRecipe extends MachineRecipeSchema {
    ...
    public static final Codec<MachineRecipeSchema> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    Identifier.CODEC.fieldOf("id").forGetter(MachineRecipeSchema::id),
                    ItemStack.CODEC.fieldOf("output").forGetter(MachineRecipeSchema::output),
                    Codec.list(ItemStack.CODEC).fieldOf("input").forGetter(schema -> new ArrayList<>(schema.input()))
