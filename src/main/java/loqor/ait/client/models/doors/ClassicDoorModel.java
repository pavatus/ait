...
public class ClassicDoorModel extends DoorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		Posts.addChild("cube_r1", ModelPartBuilder.create().uv(203, 162).cuboid(-17.0F, -64.0F, -18.0F, 4.0F, 60.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 2.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		ModelPartData Doors = classic.addChild("Doors", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		Doors.addChild("right_door", ModelPartBuilder.create().uv(0, 189).cuboid(-0.5F, -25.5F, -0.5F, 13.0F, 53.0F, 1.0F, new Dilation(0.0F))
		...
		Doors.addChild("left_door", ModelPartBuilder.create().uv(194, 21).cuboid(-12.5F, -25.5F, -0.5F, 13.0F, 53.0F, 1.0F, new Dilation(0.0F))
		...
		classic.addChild("Walls", ModelPartBuilder.create().uv(29, 106).cuboid(-13.0F, -58.0F, -15.0F, 26.0F, 3.0F, 1.0F, new Dilation(0.0F))
				.uv(109, 0).cuboid(-13.0F, -58.0F, -15.5F, 26.0F, 3.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		classic.addChild("PCB", ModelPartBuilder.create().uv(237, 162).cuboid(-14.0F, -61.0F, -18.0F, 28.0F, 4.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.0F, 0.0F));
