...
public class CapsuleDoorModel extends DoorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		top.addChild("octagon_r1", ModelPartBuilder.create().uv(125, 35).cuboid(-4.9706F, -2.0F, -12.0F, 3.0F, 2.0F, 24.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -34.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		top.addChild("octagon_r2", ModelPartBuilder.create().uv(20, 101).cuboid(-4.9706F, -2.0F, -12.0F, 9.9411F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -34.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

		top.addChild("octagon_r3", ModelPartBuilder.create().uv(93, 85).cuboid(-4.9706F, -2.0F, -12.0F, 9.9411F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -34.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		ModelPartData middle = body.addChild("middle", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 21.0F, 0.0F));

		middle.addChild("octagon_r4", ModelPartBuilder.create().uv(48, 135).cuboid(-2.2365F, -34.0F, 9.5F, 8.0F, 32.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -3.1416F, -0.7854F, 3.1416F));

		middle.addChild("octagon_r5", ModelPartBuilder.create().uv(142, 128).cuboid(-5.7635F, -34.0F, 9.5F, 8.0F, 32.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -3.1416F, 0.7854F, 3.1416F));

		middle.addChild("back", ModelPartBuilder.create().uv(146, 0).cuboid(-12.0F, -34.0F, -4.0F, 24.0F, 32.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		bottom.addChild("octagon_r6", ModelPartBuilder.create().uv(125, 68).cuboid(-4.9706F, -2.0F, -12.0F, 3.0F, 2.0F, 24.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		bottom.addChild("octagon_r7", ModelPartBuilder.create().uv(138, 55).cuboid(-4.9706F, -2.0F, -12.0F, 9.9411F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

		bottom.addChild("octagon_r8", ModelPartBuilder.create().uv(20, 128).cuboid(-4.9706F, -2.0F, -12.0F, 9.9411F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		ModelPartData doors = body.addChild("doors", ModelPartBuilder.create(), ModelTransform.of(0.0F, -2.0F, -17.0F, 0.0F, 3.1416F, 0.0F));

		doors.addChild("door_right", ModelPartBuilder.create().uv(161, 95).cuboid(0.4706F, -11.0F, -0.5F, 6.0F, 32.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-6.5F, 0.0F, -8.5F));

		doors.addChild("door_left", ModelPartBuilder.create().uv(162, 162).cuboid(-6.5294F, -11.0F, -0.5F, 6.0F, 32.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(6.5F, 0.0F, -8.5F));
