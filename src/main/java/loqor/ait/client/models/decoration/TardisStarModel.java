...
public class TardisStarModel extends SinglePartEntityModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData star = modelPartData.addChild("star", ModelPartBuilder.create().uv(0, 0).cuboid(-16.0F, -17.0F, -16.0F, 32.0F, 32.0F, 32.0F, new Dilation(0.0F))
				.uv(0, 64).cuboid(-16.0F, -17.0F, -16.0F, 32.0F, 32.0F, 32.0F, new Dilation(0.25F)), ModelTransform.of(0.0F, 9.0F, 0.0F, -0.6384F, -0.187F, -0.5372F));
