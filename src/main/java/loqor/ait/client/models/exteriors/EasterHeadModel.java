...
public class EasterHeadModel extends ExteriorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-12.0F, -1.0534F, -14.6026F, 24.0F, 14.0F, 24.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 11.0534F, 2.6026F));

		ModelPartData cube_r1 = head.addChild("cube_r1", ModelPartBuilder.create().uv(78, 57).cuboid(-9.0F, -2.0F, -11.5F, 18.0F, 19.0F, 15.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -11.0534F, 9.3974F, -0.4363F, 0.0F, 0.0F));
		...
		ModelPartData door = head.addChild("door", ModelPartBuilder.create().uv(0, 72).cuboid(-10.0F, -22.7922F, -20.2482F, 20.0F, 23.0F, 20.0F, new Dilation(0.0F))
				...
				.uv(81, 92).mirrored().cuboid(-16.0F, -30.7922F, -10.2483F, 6.0F, 31.0F, 8.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(0.0F, -1.2612F, 9.6457F));
	...
	public void renderWithAnimations(ExteriorBlockEntity exterior, ModelPart root, MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float pAlpha) {
		...
		this.head.getChild("door").pitch = (exterior.tardis().get().getDoor().isOpen()) ? -45f : 0f;
