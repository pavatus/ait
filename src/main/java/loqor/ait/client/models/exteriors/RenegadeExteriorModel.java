...
public class RenegadeExteriorModel extends ExteriorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData renegade = modelPartData.addChild("renegade", ModelPartBuilder.create().uv(0, 19).cuboid(-12.0F, -1.7F, -8.5F, 24.0F, 2.0F, 17.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

		ModelPartData walls = renegade.addChild("walls", ModelPartBuilder.create().uv(59, 61).cuboid(8.0F, -38.0F, -8.0F, 3.0F, 36.0F, 16.0F, new Dilation(0.0F))
				.uv(0, 77).cuboid(7.0F, -37.0F, -7.0F, 5.0F, 35.0F, 14.0F, new Dilation(0.0F))
				.uv(98, 98).cuboid(12.25F, -37.0F, -6.0F, 0.0F, 35.0F, 12.0F, new Dilation(0.0F))
				.uv(98, 98).cuboid(-11.25F, -37.0F, -6.0F, 0.0F, 35.0F, 12.0F, new Dilation(0.0F))
				.uv(59, 61).cuboid(-10.0F, -38.0F, -8.0F, 3.0F, 36.0F, 16.0F, new Dilation(0.0F))
				.uv(83, 5).cuboid(-11.0F, -37.0F, -7.0F, 5.0F, 35.0F, 14.0F, new Dilation(0.0F))
				.uv(98, 55).cuboid(-6.0F, -37.0F, 0.0F, 13.0F, 35.0F, 7.0F, new Dilation(0.0F))
				.uv(68, 114).cuboid(-6.0F, -37.0F, 7.25F, 13.0F, 34.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(-0.5F, 0.3F, 0.0F));

		ModelPartData roof = renegade.addChild("roof", ModelPartBuilder.create().uv(0, 0).cuboid(-12.5F, -40.75F, -8.5F, 26.0F, 1.0F, 17.0F, new Dilation(0.2F))
				.uv(0, 39).cuboid(-12.0F, -39.0F, -8.0F, 25.0F, 1.0F, 16.0F, new Dilation(0.2F))
				.uv(0, 57).cuboid(-11.0F, -42.0F, -7.0F, 23.0F, 5.0F, 14.0F, new Dilation(0.0F)), ModelTransform.pivot(-0.5F, 0.3F, 0.0F));

		ModelPartData door = renegade.addChild("door", ModelPartBuilder.create().uv(39, 114).cuboid(-0.5F, -35.0F, -0.75F, 13.0F, 35.0F, 1.0F, new Dilation(0.0F))
				.uv(122, 0).cuboid(0.0F, -34.5F, -1.0F, 12.0F, 34.0F, 0.0F, new Dilation(0.0F))
				.uv(122, 0).cuboid(0.0F, -34.5F, 0.5F, 12.0F, 34.0F, 0.0F, new Dilation(0.0F))
	...
	public void renderWithAnimations(ExteriorBlockEntity exterior, ModelPart root, MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float pAlpha) {
		...
		renegade.getChild("door").yaw = exterior.findTardis().get().getHandlers().getDoor().isOpen() ? 1.75f : 0f;
