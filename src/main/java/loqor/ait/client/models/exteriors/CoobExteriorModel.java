...
public class CoobExteriorModel extends ExteriorModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData root = modelPartData.addChild("root", ModelPartBuilder.create().uv(42, 59).cuboid(-8.0F, -16.0F,
                -8.0F, 16.0F, 16.0F, 16.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
