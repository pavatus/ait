...
public class MonitorScreen extends ConsoleScreen {
    ...
    protected void drawInformationText(DrawContext context) {
        ...
        Text dimensionText = TextUtil.worldText(abpd.getDimension());

        BlockPos dabpdPos = dabpd.getPos();

        String destinationText = dabpdPos.getX() + ", " + dabpdPos.getY() + ", " + dabpdPos.getZ();
        Text dDimensionText = TextUtil.worldText(dabpd.getDimension());
        ...
        context.drawText(this.textRenderer, TextUtil.rot2Text(abpd.getRotation()).asOrderedText(), (width / 2 - 119), (height / 2 - 28), 0xFFFFFF,
                true);
        ...
        context.drawText(this.textRenderer, TextUtil.rot2Text(dabpd.getRotation()).asOrderedText(), (width / 2 - 119), (height / 2 + 10),
                0xFFFFFF, true);
    }
