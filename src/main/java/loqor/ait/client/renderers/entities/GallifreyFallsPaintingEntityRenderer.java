...
public class GallifreyFallsPaintingEntityRenderer
    ...
    public static final Identifier PAINTING_TEXTURE = new Identifier(AITMod.MOD_ID, "textures/painting/gallifrey_falls/gallifrey_falls.png");
    public static final Identifier FRAME_TEXTURE = new Identifier(AITMod.MOD_ID, "textures/painting/gallifrey_falls/frame.png");
